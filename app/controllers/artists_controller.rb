class ArtistsController < ApplicationController
  ...
  def show
    ...
    @description_twitter = "#{@my_list.nickname}さんを構成するアーティストは%0a#{artists_list.join('%0a')}です。%0a@Buffalo_G_7777 %20%23私を構成する5組のアーティスト%20 #{myFavArtistList_url(@my_list.to_param)}"
  end
end
